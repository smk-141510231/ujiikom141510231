...
<div class="container">
 ...
 <div class="panel-body panel-primary">
                    <center><a href="{{route('penggajian.create')}}" class="btn btn-primary">Hitung Peggajian</a></center>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td><center><a href="{{route('penggajian.edit', $data->id)}}" class="btn btn-primary">Edit</a></center></td>
                <td><center>
