        ...
        <div class="col-md-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body panel-danger">
                    ...
                    <center><a href="<?php echo e(route('pegawai.create')); ?>" class="btn btn-primary">Tambah Data</a></center>
	...
	<table class="table table-bordered">
		...
		<tbody>
			<tr>
				...
				<td><center><a href="<?php echo e(route('pegawai.edit', $data->id)); ?>" class="btn btn-primary">Edit</a></center></td>
				<td><center>
