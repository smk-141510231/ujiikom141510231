...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="panel panel-black panel-danger">
                ...
                <div class="panel-body">
                    <center><a href="<?php echo e(route('tunjangan.create')); ?>" class="btn btn-primary">Tambah Data</a></center>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<td><center><a href="<?php echo e(route('tunjangan.edit', $data->id)); ?>" class="btn btn-primary">Edit</a></center></td>
			<td><center>
