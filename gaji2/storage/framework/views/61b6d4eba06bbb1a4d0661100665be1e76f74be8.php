...
<div class="container">
            ...
            <div class="panel panel-danger">
               <div class="panel-heading">LEMBUR PEGAWAI</div>
                ...
                <div class="panel-body">
                    <center><a href="<?php echo e(route('lembur_pegawai.create')); ?>" class="btn btn-primary">Tambah Data</a></center>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<td><center><a href="<?php echo e(route('lembur_pegawai.edit', $data->id)); ?>" class="btn btn-primary">Edit</a></center></td>
			<td><center>
