...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <center><a href="<?php echo e(route('kategori_lembur.create')); ?>" class="btn btn-primary">Tambah Data</a></center>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<td><center><a href="<?php echo e(route('kategori_lembur.edit', $data->id)); ?>" class="btn btn-primary">Edit</a></center></td>
			<td><center>
